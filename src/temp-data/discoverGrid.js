export const gridData = [{
        ...
        content: "Before you get too involved in what Crypto Auto Trader does, it’s important to learn about the cryptocurrency market. While you don’t have to know much beforehand, it definitely helps to understand how this popular crypto works.",
    },
    {
...
export const question = [{
        head: "HOW MUCH DOES Crypto Auto Trader COST TO USE?",
        data: "Signing up for or using Crypto Auto Trader is completely free and you are welcome to use it. To do so, you only have to register, and you can utilize the platform for yourself from your private account."
    },
    {
        head: "WHAT’S BITCOIN?",
    ...
    {
        head: "WHAT DEVICES WORK WITH Crypto Auto Trader?",
        data: "You never need to download anything, as there are no mobile apps. Everything is cloud-based, including the platform. You can access the platform by logging in through your broker’s website from any device. This includes laptops, tablets, smartphones, and everything else. As long as your preferred device has a browser and you’ve got an internet connection, Crypto Auto Trader is always accessible."
    },
